...
app.state.config.MISTRAL_OCR_USE_BASE64 = MISTRAL_OCR_USE_BASE64
app.state.config.MISTRAL_OCR_MODEL = MISTRAL_OCR_MODEL
app.state.config.VISION_LLM_API_BASE_URL = VISION_LLM_API_BASE_URL
app.state.config.VISION_LLM_API_KEY = VISION_LLM_API_KEY
app.state.config.VISION_LLM_MODEL = VISION_LLM_MODEL
app.state.config.VISION_LLM_PROMPT = VISION_LLM_PROMPT
app.state.config.VISION_LLM_MAX_TOKENS = VISION_LLM_MAX_TOKENS
app.state.config.VISION_LLM_IMAGE_DPI = VISION_LLM_IMAGE_DPI
app.state.config.VISION_LLM_CONCURRENCY = VISION_LLM_CONCURRENCY
app.state.config.VISION_LLM_MAX_CONTEXT_TOKENS = VISION_LLM_MAX_CONTEXT_TOKENS
